...
if(isset($_POST['item_name'])){
    ...
    $sql2 = "SELECT item_name FROM item_master WHERE item_name = '{$_POST['item_name']}'";
...
if (empty($emptyArr) && empty($validationArr) && empty($duplicateItem)) {
    ...
    $sql = "INSERT INTO item_master VALUES (NULL, '{$_POST['item_name']}', {$_POST['item_price']}, '{$_POST['item_description']}', '{$upload_directory}');" ;
...
echo json_encode(['empty' => $emptyArr , 'valid' => $validationArr , 'duplicateItem' => $duplicateItem , 'success' => $submitSuccess]);
